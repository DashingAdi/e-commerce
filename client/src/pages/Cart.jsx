                ...
                <Left>
                  ...
                  {products.map((item) => (
                    <Table>
                      <TableItem flex>
                        <Product>
                          <Img src={item?.product?.strMealThumb} />
                          <Details>
                            <Protitle>{item?.product?.strMeal}</Protitle>
                          </Details>
                        </Product>
                      </TableItem>
                      <TableItem>
                        <Counter>
                          <div
                            ...
                            onClick={() =>
                              removeCart(item?.product?.idMeal, item?.quantity - 1)
                            }
                          >
                            -
                          </div>
                          ...
                          <div
                            ...
                            onClick={() => addCart(item?.product?.idMeal)}
                          >
                            +
                          </div>
                        </Counter>
